...
> Apri questa pagina in [https://coguars.github.io/move-motor-clap-control/](https://coguars.github.io/move-motor-clap-control/)
...
* cerca **https://github.com/coguars/move-motor-clap-control** ed importa

## Modifica questo progetto ![Badge stato build](https://github.com/coguars/move-motor-clap-control/workflows/MakeCode/badge.svg)

Per modificare questa repository in MakeCode.

* apri [https://makecode.microbit.org/](https://makecode.microbit.org/)
* clicca su **Importa** quindi fai clic su **Importa INDIRIZZO**
* incolla **https://github.com/coguars/move-motor-clap-control** e clicca importa
...
![Un'immagine renderizzata dei blocchi](https://github.com/coguars/move-motor-clap-control/raw/master/.github/makecode/blocks.png)
